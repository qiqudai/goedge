...
- This repository must follow the project-level execution skill:
  - `docs/PROJECT_SKILL.md`
  - `docs/AI_DEVELOPMENT_RULES_V2.md`
- If this file conflicts with the project skill documents above, project skill documents take precedence.
- For any architecture/runtime/state-machine change, reviewers should enforce the merge gate checklist from `docs/PROJECT_SKILL.md`.
