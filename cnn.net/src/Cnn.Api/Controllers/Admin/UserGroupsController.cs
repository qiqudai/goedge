...
[ApiController]
[Route("api/v1/admin/user_groups")]
public sealed class UserGroupsController : ControllerBase
{
    private readonly IUserGroupService _service;
    private readonly IMessageLocalizer _localizer;

    public UserGroupsController(IUserGroupService service, IMessageLocalizer localizer)
    {
        _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] UserGroupUpsertRequest request, CancellationToken cancellationToken)
    {
