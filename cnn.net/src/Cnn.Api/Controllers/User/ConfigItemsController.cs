...
[ApiController]
[Route("api/v1/user/config_items")]
public sealed class ConfigItemsController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = await _service.ListUserAsync(userId, type, cancellationToken);
    ...
    public async Task<IActionResult> UpsertAsync([FromBody] ConfigItemUpsertRequest request, CancellationToken cancellationToken)
    {
        ...
        var result = await _service.UpsertUserAsync(userId, request, cancellationToken);
        return ToResponse(result);
    }
