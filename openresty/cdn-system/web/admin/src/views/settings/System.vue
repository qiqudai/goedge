    ...
    <el-tabs v-model="activeTab" type="border-card">
      ...
      <el-tab-pane label="系统配置" name="system">
        <el-form label-width="120px" :model="form">
            ...
            <el-form-item label="底部链接">
                 <!-- Simple text area for now, or dynamic list -->
                 <el-input v-model="form.footer_text" type="textarea" placeholder="Format: Name|URL" rows="3"/>
            </el-form-item>
      ...
      <el-tab-pane label="数据清理" name="cleaning">
         <el-form label-width="180px" :model="form">
            <el-form-item label="清缓存/解锁IP记录"><el-input v-model="form.clean_cache_days"><template #append>天</template></el-input></el-form-item>
            <el-form-item label="登录记录"><el-input v-model="form.clean_login_log_days"><template #append>天</template></el-input></el-form-item>
            <el-form-item label="操作记录"><el-input v-model="form.clean_op_log_days"><template #append>天</template></el-input></el-form-item>
            <el-form-item label="网站访问日志(ES)"><el-input v-model="form.clean_site_log_days"><template #append>天</template></el-input></el-form-item>
            <el-form-item label="节点监控数据"><el-input v-model="form.clean_node_monitor_days"><template #append>天</template></el-input></el-form-item>
             <el-form-item label="流量带宽历史"><el-input v-model="form.clean_traffic_days"><template #append>天</template></el-input></el-form-item>

             <el-divider>数据备份</el-divider>
             <el-form-item label="备份频率"><el-input v-model="form.backup_frequency"><template #append>天</template></el-input></el-form-item>
             <el-form-item label="保留天数"><el-input v-model="form.backup_retention"><template #append>天</template></el-input></el-form-item>
      ...
      <el-tab-pane label="通知配置" name="notify">
           <el-form label-width="180px" :model="form">
               <el-card shadow="never" class="mb-20">
                   ...
                   <el-form-item label="开关"><el-switch v-model="form.notify_traffic_exceeded" /></el-form-item>
                ...
                <el-card shadow="never" class="mb-20">
                   ...
                   <el-form-item label="开关"><el-switch v-model="form.notify_traffic_low" /></el-form-item>
                   <el-form-item label="阈值(GB)"><el-input v-model="form.notify_traffic_low_threshold" /></el-form-item>
               </el-card>

               <el-card shadow="never" class="mb-20">
                   <template #header>套餐过期通知</template>
                   <el-form-item label="开关"><el-switch v-model="form.notify_expire" /></el-form-item>
               </el-card>
       ...
       <el-tab-pane label="HTTPS设置" name="https">
           <el-form label-width="120px" :model="form">
               ...
               <el-alert title="保存后需要重启 Master 服务生效" type="info" show-icon />
