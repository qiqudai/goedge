  ...
  <div class="app-container">
    <el-card>
      ...
      <el-tabs type="border-card" v-if="config.waf">
        <!-- 1. Basic & Block Strategy -->
        <el-tab-pane label="基础防护 & 拉黑策略">
            <el-form label-width="180px">
                <el-form-item label="全局 WAF 开关">
                ...
                <el-form-item label="触发阈值" v-if="config.waf.auto_ipset_enable">
                    ...
                    <span class="unit">次拉黑/秒</span>
                    <div class="tip">当单站每秒拉黑次数超过此值时，自动升级为 IPSet 拉黑。</div>
                </el-form-item>
                ...
                <el-form-item label="频率阈值" v-if="config.waf.block_page_rate_limit_enable">
                    ...
                    <div class="tip">单IP访问拉黑页面超过此频率，直接升级 IPSet 拉黑。</div>
                </el-form-item>
                ...
                <el-form-item label="黑名单封禁时长">
                    <el-input-number v-model="config.waf.blacklist_timeout" /> <span class="unit">秒</span>
                </el-form-item>
                <el-form-item label="临时白名单时长">
                    <el-input-number v-model="config.waf.temp_whitelist_timeout" /> <span class="unit">秒</span>
                </el-form-item>
        ...
        <el-tab-pane label="CC 防护 & 验证">
            <el-form label-width="180px">
                ...
                <el-form-item label="自动开启阈值" v-if="config.waf.default_page_protection === 'auto'">
                    <el-input-number v-model="config.waf.default_page_protection_threshold" /> <span class="unit">请求/秒</span>
                </el-form-item>
        ...
        <el-tab-pane label="高级防护 & 系统">
            <el-form label-width="180px">
                ...
                <el-form-item label="404 阈值">
                    <el-input-number v-model="config.waf.well_known_protection_threshold" /> <span class="unit">次 / 60秒</span>
                    <div class="tip">超过此值 IP 将不再回源 300秒 (防止 ACME 验证泛滥)</div>
                </el-form-item>
                ...
                <h4>内置资源防护 (防CC图片/JS)</h4>
                 ...
                 <el-form-item label="开启阈值">
                    <el-input-number v-model="config.waf.resource_protection_threshold" /> <span class="unit">QPS</span>
                </el-form-item>
                 <el-form-item label="拉黑时长">
                    <el-input-number v-model="config.waf.resource_protection_block_timeout" /> <span class="unit">秒</span>
                </el-form-item>
