    ...
    children: [
      ...
      // 3. 网站管理 (Shared)
      {
        ...
        children: [
          ...
          { path: 'groups', name: 'SiteGroups', component: () => import('../views/website/Groups.vue'), meta: { title: '网站分组', roles: ['admin'] } },
          { path: 'resolve', name: 'SiteResolve', component: () => import('../views/website/Resolve.vue'), meta: { title: '解析检测', roles: ['admin'] } },
