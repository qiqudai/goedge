...
[ApiController]
[Route("api/v1/admin/rules/cc/groups")]
public sealed class CcRuleGroupsController : ControllerBase
{
    private readonly ICcRuleGroupService _service;
    ...
    public CcRuleGroupsController(
        ICcRuleGroupService service,
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] CcRuleGroupUpsertRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> UpdateAsync(long id, [FromBody] CcRuleGroupUpsertRequest request, CancellationToken cancellationToken)
    {
