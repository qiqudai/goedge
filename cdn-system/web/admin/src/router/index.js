    ...
    children: [
      ...
      // 3. 网站管理 (Shared)
      {
        ...
        children: [
          ...
          { path: 'manage', name: 'SiteManage', component: () => import('../views/website/Manage.vue'), meta: { title: '网站配置', roles: ['admin', 'user'], hidden: true } },
      ...
      // 6. 系统管理 (Admin Only)
      {
        ...
        children: [
          ...
          { path: 'logs', name: 'SystemLogs', component: () => import('../views/system/Logs.vue'), meta: { title: '系统日志' } },
