...
print(json.dumps({
    "settings_realtime_send": settings.get("realtime_send"),
    "settings_realtime_return": settings.get("realtime_return"),
    "settings_realtime_identify": settings.get("realtime_identify"),
    "advanced_realtime_send": adv.get("realtime_send"),
    "advanced_realtime_return": adv.get("realtime_return"),
    "advanced_realtime_identify": adv.get("realtime_identify"),
}, ensure_ascii=False))
