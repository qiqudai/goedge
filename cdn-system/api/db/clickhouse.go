...
func clickHouseTableStmts() []string {
	return []string{
		...
		`ALTER TABLE node_access_logs ADD COLUMN IF NOT EXISTS block_source String AFTER upstream_cache_status`,
		`ALTER TABLE node_access_logs ADD COLUMN IF NOT EXISTS slow_reason String AFTER block_source`,
